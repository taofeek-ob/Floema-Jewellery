...
export default class Media {
  ...
  update(scroll, index) {
    ...
    this.element.parentElement.style.pointerEvents = index === this.index ? 'auto' : 'none';
    this.element.querySelector('.collections__gallery__media__image').style.pointerEvents = index === this.index ? "auto" : 'none';
